...
highlight: agate
---
随着 TypeScript 越来越火，更多的人开始使用 TypeScript，同时原来的 JavaScript 编码风格也不能完全适用于 TypeScript 了。

[本文](https://github.com/zhl1232/clean-code-typescript)修改了中文版本的一些内容，比如 `TSLint` 等等。中文版有几个`repo`翻译，选取了一个翻译比较好的。
...
![Humorous image of software quality estimation as a count of how many expletives you shout when reading code](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2eb96850744b4185b77f48f155edf7af~tplv-k3u1fbpfcp-zoom-1.image)
...
重复乃万恶之源！重复意味着如果要修改某个逻辑，需要修改多处代码😢。
...
合理的抽象至关重要，这就是为什么您应该遵循`SOLID原则`。糟糕的抽象可能还不如重复代码，所以要小心！话虽如此，还是要做好抽象！尽量不要重复。
...
> VSCode 可以使用 [TODO Highlight](https://marketplace.visualstudio.com/items?itemName=wayou.vscode-todo-highlight)
